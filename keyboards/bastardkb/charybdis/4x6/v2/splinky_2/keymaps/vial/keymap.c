...
// ===================== СЛУЖЕБНЫЕ МАРКЕРЫ ДЛЯ COMBO-СБРОСА =====================
enum custom_keycodes { EE_A = SAFE_RANGE, EE_B };
// ===================== TAP DANCE (Стрелки) =====================
